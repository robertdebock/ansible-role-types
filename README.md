...
![dependencies](https://raw.githubusercontent.com/robertdebock/drawings/artifacts/types.png "Dependency")
...
[Unit tests](https://travis-ci.com/robertdebock/ansible-role-types) are done on every commit, pull request, release and periodically.
